...
class PeasDetailScreen extends StatelessWidget {
  @override
                  ...
                  ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Peas can be grown in all types of soils such as sandy loam, clay loam, silt loam and heavy soils. However, the best soil for successful Peas cultivation is deep, friable loam and alluvial soils with good drainage, moisture holding capacity and sufficient organic matter. In heavy soils, the bulbs produced may be deformed. Peas crop can be grown successfully on heavy soil with application of organic manure prior to planting and preparation of the field for Peas cultivation should be very good. The optimum pH range, regardless of soil type, is 6.0 - 7.5, but Peas can also be grown in mild alkaline soils. Peas crop is more sensitive to highly acidic, alkali and saline soils and water logging condition. Peas do not thrive in soils having pH below 6.0 because of trace element deficiencies, or occasionally, Al or Mn toxicity. The threshold electrical conductivity of a saturation extract (ECe) for Peas crop is 4.0 dS/m. When the ECe level exceeds this, crop yield starts declining.",
                          textAlign: TextAlign.justify,
                        )
                      ],
                    ),
                  ...
                  ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Peas is harvested depending upon the purpose for which the crop is planted. 0nion crop is ready for harvesting in five months for dry Peas. However, for marketing as green Peas, the crop becomes ready in three months after transplanting.",
                          textAlign: TextAlign.justify,
                        ),
                        SizedBox(
                          height: 5,
                        ...
                        Text(
                          "n kharif season, since tops do not fall, bulbs are harvested soon after the colour of leaves changes to slightly yellow and red pigmentation on bulbs develop. Best time to harvest rabi Peas is one week after 50% tops have fallen over. Peass for sale as dried bulbs or for storage should be harvested progressively after tops have started falling over.",
                          textAlign: TextAlign.justify,
                        )
                      ],
                    ),
