...
class OnionDetailScreen extends StatelessWidget {
  @override
                  ...
                  ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "n kharif season, since tops do not fall, bulbs are harvested soon after the colour of leaves changes to slightly yellow and red pigmentation on bulbs develop. Best time to harvest rabi onion is one week after 50% tops have fallen over. Onions for sale as dried bulbs or for storage should be harvested progressively after tops have started falling over.",
                          textAlign: TextAlign.justify,
                        )
                      ],
                    ),
