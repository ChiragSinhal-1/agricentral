                  ...
                  ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Fruits like tomato can be grown in all types of soils such as sandy loam, clay loam, silt loam and heavy soils. However, the best soil for successful Fruits like tomato cultivation is deep, friable loam and alluvial soils with good drainage, moisture holding capacity and sufficient organic matter. In heavy soils, the bulbs produced may be deformed. Fruits like tomato crop can be grown successfully on heavy soil with application of organic manure prior to planting and preparation of the field for Fruits like tomato cultivation should be very good. The optimum pH range, regardless of soil type, is 6.0 - 7.5, but Fruits like tomato can also be grown in mild alkaline soils. Fruits like tomato crop is more sensitive to highly acidic, alkali and saline soils and water logging condition. Fruits like tomato do not thrive in soils having pH below 6.0 because of trace element deficiencies, or occasionally, Al or Mn toxicity. The threshold electrical conductivity of a saturation extract (ECe) for Fruits like tomato crop is 4.0 dS/m. When the ECe level exceeds this, crop yield starts declining.",
                          textAlign: TextAlign.justify,
                        )
                      ],
                    ),
                  ...
                  ListTile(
                    title: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Fruits like tomato is harvested depending upon the purpose for which the crop is planted. 0nion crop is ready for harvesting in five months for dry Fruits like tomato. However, for marketing as green Fruits like tomato, the crop becomes ready in three months after transplanting.",
                          textAlign: TextAlign.justify,
                        ),
                        SizedBox(
                          height: 5,
                        ...
                        Text(
                          "n kharif season, since tops do not fall, bulbs are harvested soon after the colour of leaves changes to slightly yellow and red pigmentation on bulbs develop. Best time to harvest rabi Fruits like tomato is one week after 50% tops have fallen over. Fruits like tomatos for sale as dried bulbs or for storage should be harvested progressively after tops have started falling over.",
                          textAlign: TextAlign.justify,
                        )
                      ],
                    ),
